...
public class TreeSimple : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other) {
        ...
        if (other.CompareTag("Player")) {
            ...
            if (isLevel2) {
                ...
                // REVISI: Jika sudah dianjurkan wajib zakat ternak (Misi Kantor Zakat muncul), KUNCI POHON!
                bool wajibZakatTernak = false;
                if (TaskManager.instance != null && TaskManager.instance.barKeKantorZakat != null) {
                    // Jika bar kantor zakat aktif berarti pemain sedang disuruh ke kantor zakat
                    wajibZakatTernak = TaskManager.instance.barKeKantorZakat.activeSelf || (ZakatPanelManager.instance != null && ZakatPanelManager.instance.isPeternakanCompleted);
                }
                ...
                // LEVEL 1: REVISI KEMBALI KE LOGIKA ASLI (Jika target nisab tercapai / disuruh ke kantor zakat, KUNCI POHON!)
                if (globalNoChopLevel2Group != null) globalNoChopLevel2Group.SetActive(false);

                bool sudahNisabLevel1 = false;
                if (TaskManager.instance != null) {
                    sudahNisabLevel1 = TaskManager.instance.barKeKantorZakat != null && TaskManager.instance.barKeKantorZakat.activeSelf;
                }

                if (sudahNisabLevel1 || (ZakatPanelManager.instance != null && ZakatPanelManager.instance.isPerdaganganCompleted)) {
                    if (globalChopGroup != null) globalChopGroup.SetActive(false);
                    if (globalNoChopGroup != null) globalNoChopGroup.SetActive(true);
                } 
                else {
    ...
    void OnTriggerExit(Collider other) {
        if (other.CompareTag("Player")) {
            ...
            if (moveScript != null) moveScript.StopHarvesting();
    ...
    void ActionPotong() {
        ...
        if (!isLastHit) {
            ...
            if (woodParticlePrefab != null) Instantiate(woodParticlePrefab, spawnPos, Quaternion.identity);
    ...
    void Tumbang() {
        ...
        if (player != null) {
            PlayerMovement moveScript = player.GetComponent<PlayerMovement>();
            if (moveScript != null) {
                moveScript.isLockedInAction = false; 
